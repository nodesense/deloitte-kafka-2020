...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"kafka.workshop.models\",\"fields\":[{\"name\":\"id\",\"type\":[\"null\",\"int\"],\"default\":null},{\"name\":\"name\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"price\",\"type\":[\"null\",\"int\"],\"default\":null},{\"name\":\"create_ts\",\"type\":{\"type\":\"long\",\"connect.version\":1,\"connect.name\":\"org.apache.kafka.connect.data.Timestamp\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"update_ts\",\"type\":{\"type\":\"long\",\"connect.version\":1}}],\"connect.name\":\"products\"}");
   ...
   */
  public Product(java.lang.Integer id, java.lang.CharSequence name, java.lang.Integer price, java.time.Instant create_ts, java.lang.Long update_ts) {
    this.id = id;
    this.name = name;
    this.price = price;
   ...
   * @param value the value to set.
   */
  public void setUpdateTs(long value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.workshop.models.Product.Builder setUpdateTs(long value) {
